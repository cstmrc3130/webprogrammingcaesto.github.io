...
var snowStorm = (function (e, d) {
    ...
    function t() {
      if ((this.excludeMobile && !u) || !this.excludeMobile)
    ...
    this.scrollHandler = function () {
      p = a.flakeBottom
        ? 0
        : parseInt(
            e.scrollY || d.documentElement.scrollTop || d.body.scrollTop,
            10
          );
      if (isNaN(p)) p = 0;
      if (!q && !a.flakeBottom && a.flakes)
        for (var c = a.flakes.length; c--; )
          a.flakes[c].active === 0 && a.flakes[c].stick();
    };
    ...
    this.resizeHandlerAlt = function () {
      ...
      l = a.flakeBottom
        ? a.flakeBottom
        : a.targetElement.offsetTop + a.targetElement.offsetHeight;
      n = parseInt(k / 2, 10);
    };
    ...
    this.stop = function () {
      this.freeze();
      for (var c = this.flakes.length; c--; )
    ...
    this.show = function () {
      for (var c = this.flakes.length; c--; )
        this.flakes[c].o.style.display = "block";
    };
    this.SnowFlake = function (c, h, i, g) {
      ...
      this.stick = function () {
        if (
          v ||
          (c.targetElement !== d.documentElement && c.targetElement !== d.body)
        )
          b.o.style.top = l + p - c.flakeHeight + "px";
      ...
      this.move = function () {
        ...
        else if (f < 0 && b.x - c.flakeLeftOffset < 0 - c.flakeWidth)
          b.x = k - c.flakeWidth - 1;
        b.refresh();
        if (l + p - b.y < c.flakeHeight) {
          ...
          if (c.useTwinkleEffect)
            if (b.twinkleFrame) {
              b.twinkleFrame--;
              b.o.style.visibility =
                b.twinkleFrame && b.twinkleFrame % 2 === 0 ? "hidden" : "visible";
            } else if (Math.random() > 0.9)
              b.twinkleFrame = parseInt(Math.random() * 20, 10);
        }
      };
      ...
      this.melt = function () {
        if (!c.useMeltEffect || !b.melting) b.recycle();
          ...
          b.o.style.lineHeight =
            c.flakeHeight +
            2 +
            c.flakeHeight * 0.75 * (b.meltFrame / b.meltFrameCount) +
            "px";
        } else b.recycle();
      };
    ...
    this.timerInit = function () {
      a.timers = !D
        ? [setInterval(a.snow, a.animationInterval)]
        : [
            setInterval(a.snow, a.animationInterval * 3),
            setInterval(a.snow, a.animationInterval),
          ];
    };
    this.init = function () {
      for (var c = 0; c < a.meltFrameCount; c++)
      ...
      if (!a.targetElement)
        a.targetElement = !m
          ? d.documentElement
            ...
            : d.body
          : d.body;
      if (a.targetElement !== d.documentElement && a.targetElement !== d.body)
